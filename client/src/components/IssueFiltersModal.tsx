  ...
  return (
    ...
    >
      <div
        ...
        className="relative my-auto w-full max-w-lg max-h-[min(90vh,100%)] overflow-y-auto rounded-2xl border border-border/90 bg-surface-900 p-5 shadow-[var(--shadow-elevated)] sm:p-6"
